...
$sql = "SELECT * FROM supplier_list WHERE supplier_id LIKE '%$search1%' || supplier_name LIKE '%$search1%' || supplier_contact LIKE '%$search1%' || supplier_email LIKE '%$search1%' || supplier_address LIKE '%$search1%' || supplier_del_date LIKE '%$search1%' || supplier_del_status LIKE '%$search1%' || supplier_order_num LIKE '%$search1%' ORDER BY supplier_id DESC";
