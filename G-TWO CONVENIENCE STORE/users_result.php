...
$sql = "SELECT * FROM store_users WHERE user_num LIKE '%$search1%' || user_fname LIKE '%$search1%' || user_lname LIKE '%$search1%' || user_age LIKE '%$search1%' || user_bdate LIKE '%$search1%' || user_address LIKE '%$search1%' || user_position LIKE '%$search1%' || user_shift LIKE '%$search1%' ORDER BY user_id DESC";
...
<body>
	...
	<!-- jumbotron -->
	<div class="container text-center mt-3 mb-4 p-3 border shadow bg-secondary text-white rounded h1">USERS LIST</div>
	<!-- end of jumbotron -->
	...
	<div class="container mb-3 p-0">
		<form class="d-flex" action="users_result.php" method="GET">
			<div class="pe-2">
				...
				<a href="register.php" class="btn btn-secondary ms-auto text-decoration-none text-white mb-1"><i class='bi bi-plus-square'></i> NEW USER</a>
			</div>
			...
			<a class="btn btn-outline-secondary pe-3 ps-3 mb-1" href="users.php">Clear</a>
		</form>
	</div>
	<!-- end of add button -->
				...
				<table class="table table-striped table-hover">
					...
					<tbody>	
						...
						<tr>
							...
							<td>
								<div class="">
									<a class="btn btn-secondary p-1 pe-2 ps-2" href="user_edit.php?ID=<?php echo $row['user_id']; ?>" name="edit"><i class='bi bi-pen'></i></a>	
									  ...
									  <div class="modal-dialog">
									    <div class="modal-content">
									      ...
									      <div class="modal-footer">
									        ...
									        <a class="btn btn-danger" href="user_delete.php?user_delete=<?php echo $row['user_id']; ?>"data-bs-toggle="modal" data-bs-target="user_delete.php?user_delete=<?php echo $row['user_id']; ?>">Yes</a>
									      </div>
									    </div>
									  </div>
									</div>
